...
> **Source:** `<URL, file path in raw/, or description of where this information comes from>`
...
If the one-line summary for any updated page has changed, update it in the table:

```markdown
| [[<slug>]] | New summary | tags | <today> |
```

Update the `updated` date in the page's frontmatter.

### 6. Append to `wiki/log.md`

Always append — do not ask permission, do not skip:
